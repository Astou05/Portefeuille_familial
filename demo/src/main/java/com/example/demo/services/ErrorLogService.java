...
public class ErrorLogService {
    ...
    @Autowired
    private ErrorLogRepository errorLogRepository; // minuscule corrigé

    public void log(String endpoint, String method,
                    int statusCode, String message, String parameters) {
        ErrorLog log = new ErrorLog(endpoint, method, statusCode, message, parameters);
        errorLogRepository.save(log);
    }
}