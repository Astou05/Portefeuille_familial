...
public class ErrorLog {
    ...
    public ErrorLog(String endpoint, String method, int statusCode,
    ...
    public int getStatusCode()     { return statusCode; }
    public String getEndpoint()    { return endpoint; }
    public String getMethod()      { return method; }       // corrigé : était getMethode()
    public String getMessage()     { return message; }
    public String getParameters()  { return parameters; }  // corrigé : était getParametres()
}